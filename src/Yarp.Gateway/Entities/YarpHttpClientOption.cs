...
{
    public class YarpHttpClientOption
    {
        [Key]
        ...
        /// </summary>
        public static readonly YarpHttpClientOption Empty = new();
        ...
        /// </summary>
        public virtual YarpWebProxyConfig? WebProxy { get; init; }
        ...
        public bool Equals(YarpHttpClientOption? other)
        {
            if (other == null)
            {
                return false;
