...
{
    public class YarpSessionAffinityCookie
    {
        [Key]
        ...
        public Guid? SessionAffinityConfigId { get; init; }

        [ForeignKey("SessionAffinityConfigId")]
        public virtual YarpSessionAffinityConfig SessionAffinityConfig { get; init; }

        public bool Equals(YarpSessionAffinityCookie? other)
        {
            if (other == null)
            {
                return false;
